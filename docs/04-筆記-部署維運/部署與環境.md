...
> 蒸餾自五月日誌（Docker／nginx／SSL／CI-CD 段落）與 CloudDrive 期的環境實測記錄。完整的當時脈絡與截圖見 W2–W4 週誌（[Docker 容器化](../01-日誌/W2-0512~0518.md)、[部署與認證](../01-日誌/W3-0519~0525.md)、[網域與 HTTPS](../01-日誌/W4-0526~0601.md)）。
...
![用 nano 建立 crontab](../assets/log-picture/20260529/用nano建立crontab.png)

![確認 certbot log 檢查憑證期限](../assets/log-picture/20260529/確認certbot_log檢查憑證期限.png)

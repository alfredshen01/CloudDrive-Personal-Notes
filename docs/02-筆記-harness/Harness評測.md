...
> 本篇分兩部分:**第一部**說明評測系統「怎麼設計、如何測」,**第二部**是「測試結果與分析」。
...
| temperature | thinking 開啟 通過率 | think:false 通過率 |
|---|---|---|
| 0.2 | 90% | 100% |
| 0.4 | 90% | 100% |
| 0.6 | 85% | 100% |
...
【圖表 4：temperature 掃描 thinking 開啟 vs think:false 之通過率對比折線】
...
| 圖表 4 | temperature 掃描 thinking 開 vs think:false 對比 | 雙線折線 | 附錄 C |
